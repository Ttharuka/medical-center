...
namespace Medcs.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Redirect(int? id, [FromForm]string method)
        {
            if(method == "cash")
            {
                return LocalRedirect("/Payments/Edit/"+id.ToString());
            }
            else
            {
                return LocalRedirect("/CardPayment?id="+id.ToString());
            }
            return View();
        }
        ...
        {
            var medicalcenterContext = _context.Payments.Include(p => p.Appointment);
